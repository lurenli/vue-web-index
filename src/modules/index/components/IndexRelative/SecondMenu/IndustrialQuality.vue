      ...
      <div class="keywords_content2"  >
        ...
        <div class="MyBrand_section" v-for="MyBrand in MyBrands">
          ...
          <p class="MyBrand_detail">
            <span>{{MyBrand.productname}}&nbsp;&nbsp;<span v-if="MyBrand.producttype=='紧固件'">{{MyBrand.level3}}</span>&nbsp;&nbsp;{{MyBrand.productalias}}&nbsp;&nbsp;{{MyBrand.subtitle}}</span>
          </p>
...
//              }
      ...
      getUrl:function(){
        ...
        let SearchURL="/IndustrialQuality/search"+this.getparam+"?"+this.getquery+".html";
