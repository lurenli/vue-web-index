<template>
  <div class="city-choice">
    ...
    <div id="addr-choice">
      <ul id="title-wrap">
        <li value="0" ><span class="addressactive">请选择省</span></li>
        <li value="1"><span>请选择市</span></li>
        <li value="2"><span>请选择区</span></li>
      </ul>
      <div id="show-panel">
        <ul id="addr-wrap">
        </ul>
  ...
  export default {
    ...
    methods:{
      address:function(){
        ...
        let addrShow02 =document.getElementById('addr-show02');  //最终地址显示框
        let ul = document.getElementById('title-wrap');
        let titleWrap= ul.getElementsByTagName('li');
        let underline=ul.getElementsByTagName('span');
        let addrWrap =document.getElementById('addr-wrap');   //省市区显示模块
        let addrChoice=document.getElementById('addr-choice');
        let iconChange=document.getElementsByClassName('icon down')[0];
        //显示和隐藏
        function Show_Hidden(obj)
        {
          if(obj.style.display=="block")
          {
            ...
            iconChange.classList.remove('up');
            iconChange.classList.add('down');
          }
          else
          {
            obj.style.display='block';
            iconChange.classList.remove('down');
            iconChange.classList.add('up');
          }
        }
        city.onclick=function()
        {
          Show_Hidden(addrChoice);
          return false;
        };
        //
        let current2 = {
        ...
        function showProv2() {
          addrWrap.innerHTML = '';
          addrShow02.innerHTML='浙江省 杭州市 萧山区';
          titleWrap[0].className = 'titleSel';
          underline[0].className='addressactive';
        ...
        function showCity2(index) {
          ...
          underline[0].className='';
          underline[1].className='addressactive';
          ...
          addrShow02.innerHTML = current2.provVal;
        }
        ...
        function showCountry2(index) {
          ...
          underline[2].className='addressactive';
          ...
          addrShow02.innerHTML = current2.provVal + ' ' + current2.cityVal + ' ';
        }
        ...
        function selectCountry(index) {
          ...
          addrShow02.innerHTML = current2.provVal + ' ' + current2.cityVal + ' ' + current2.countryVal;
          addrWrap.getElementsByTagName('li')[current2.country].style.backgroundColor = '';
          addrChoice.style.display='none';
        }
        /*分别点击省市区标题的处理函数*/
